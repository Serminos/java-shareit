...
public class BookingController {
    ...
    public BookingResponce saveRequest(@RequestHeader("X-Sharer-User-Id") Long userId,
    ...
    public BookingResponce approved(@RequestHeader("X-Sharer-User-Id") Long ownerId,
    ...
    public BookingResponce findById(@RequestHeader("X-Sharer-User-Id") Long userId,
                                    @PathVariable Long bookingId) {
    ...
    @GetMapping
    public List<BookingResponce> findAllByUserId(@RequestHeader("X-Sharer-User-Id") Long userId,
    ...
    @GetMapping("/owner")
    public List<BookingResponce> findAllByOwnerId(@RequestHeader("X-Sharer-User-Id") Long ownerId,
                                                  @RequestParam(defaultValue = "ALL") String state) {
